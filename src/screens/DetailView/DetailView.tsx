...
const DetailView: React.FC = () => {
  ...
  const { appCompID }: LIST_OBJECT = route.params.extraData;
        ...
        <ImageBackground
          ...
          <View style={styles.subHead}>
            <View style={styles.subHead1}>
              <Text style={styles.text1}>{details?.appCompName}</Text>
    ...
    return (
      <>
        <View style={styles.head1}>
          {/* <CustomContainer
            header={details?.appCompName}
            // topRightText={}
            description={`Located in ${details?.areaName},${details?.districtName}.`}
          /> */}
          <View style={styles.card}>
            <View style={styles.card2}>
              <Text style={styles.head2}>{`Ratings and reviews`}</Text>
              <TouchableOpacity style={styles.arrow} onPress={reviewListView}>
                <FontAwesome name="arrow-right" size={15}></FontAwesome>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.rate}>
              <View style={styles.rate1}>
                <Text style={styles.textRate}>{details?.overAllRating}</Text>
                <AirbnbRating
                  count={5}
                  defaultRating={details?.overAllRating}
                  size={10}
                  selectedColor={Colors.darkgreen}
                  showRating={false}
                  isDisabled={true}
                />
                <Text style={styles.text3}>{details?.noOfReviews} Reviews</Text>
              </View>
